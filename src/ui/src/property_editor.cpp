...
static void _show_rel(Ref<Scene> scene, relid id);

static void _show_input(Ref<Scene> scene, Node id)
{
...
static void _show_output(Ref<Scene> scene, Node id)
{
...
static void _show_component(Ref<Scene> scene, Node id) { }

static void _show_gate(Ref<Scene> scene, Node id)
{
    if (ImGui::IsItemFocused() && !ImNodes::IsNodeSelected(id.numeric())) {
        ImNodes::SelectNode(id.numeric());
    }
...
static void _show_node(Ref<Scene> scene, Node id)
{
    switch (id.type) {
